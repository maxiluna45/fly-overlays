...
const { sameTrack, sameCar, isComparableReference } = require('../src/renderer/lib/session-match');
...
test('un CSV de Garage 61 es referencia válida de una sesión de iRacing del mismo circuito', () => {
...
test('el nombre interno de iRacing y el display de Garage 61 se reconocen como el mismo circuito', () => {
...
test('dos sesiones de iRacing del mismo circuito y auto son comparables', () => {
...
test('circuitos distintos no son comparables', () => {
...
test('sesiones sin datos de circuito no son comparables', () => {
...
test('sameTrack sigue tolerando prefijos genéricos y variantes de escritura', () => {
